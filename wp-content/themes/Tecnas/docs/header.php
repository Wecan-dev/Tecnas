...
<head>
  ...
  <title>Tecnas | <?php echo lang() == 'es' ? "Socios en su progreso" : "Partners in your progress"; ?></title>
...
Customer service";} ?></a>
      ...
      <li class='nav-item'>
      <!--     <a class='nav-link' href='#'><?php if(lang() == 'es'){echo "Redes Sociales";}if(lang() == 'en'){echo "Social Media";} ?></a> -->
        </li>
      </ul>
    </div>
  </nav>  
