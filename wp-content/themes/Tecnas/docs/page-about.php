<?php get_header() ?>
  ...
  <section class="page-container">
    ...
    <div class="main-about mb-5">
      <div class="about-video">
        <img alt="Nuestra empresa" src="<?php echo get_template_directory_uri(); ?>/assets/img/about_video.png">
      </div>
      ...
      <div class="row">
        <div class="col-lg-3">
          <div class="support-item">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/about_pillars_1.png">
            <h3>Talento humano</h3>
          </div>
        </div>
        <div class="col-lg-3">
          <div class="support-item">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/about_pillars_2.png">
        ...
        <div class="col-lg-3">
          <div class="support-item">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/about_pillars_3.png">
            <h3>Investigación innovación y tecnología</h3>
            </img>
          </div>
        </div>
        <div class="col-lg-3">
          <div class="support-item">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/about_pillars_4.png">
  ...
  <div class="main-benefits">
    <div class="benefit-item">
      <img alt="Salud y Bienestar" src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/heart.png">
    ...
    <div class="benefit-item">
      <img alt="Servicio con calidez" src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/shaking_hands.png">
      <div class="benefit-divider"></div>
      <h4>
        Servicio con
        <br>
    ...
    <div class="benefit-item">
      <img alt="Investigación, innovacion y Desarrollo" src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/laboratory.png">
      <div class="benefit-divider"></div>
      <h4>
        Investigación,
        <br>
    ...
    <div class="benefit-item">
      <img alt="Asesoría Integral" src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/gear.png">
      <div class="benefit-divider"></div>
      <h4>
        Asesoría
        <br>
